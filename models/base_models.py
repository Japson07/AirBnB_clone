...
class BaseModel:
    """This class will define the common attributes or methods for
    the other classes
    """
    id = Column(String(00), nullable=False, primary_key=True)
    created_at = Column(DateTime, default=datetime.utcnow, nullable=False)
    updated_at = Column(DateTime, default=datetime.utcnow, nullable=False)

    def __init__(self, *args, **kwargs):
        """to instantiate the base model class
        Args:
            args: wont be used
            kwargs: arguments for the constructors of the base model
        attributes:
            id: unique id that will be generated
